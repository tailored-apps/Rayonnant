...
namespace Wise.Framework.Presentation.Tests
{
    ...
    {
        private Mock<ICommandsViewModel> commandsViewModel = new Mock<ICommandsViewModel>();
        ...
        public void CanFindProperItem()
        {
                ...
                ItemsSource = new ObservableCollection<MenuItem>(new List<MenuItem>()
            {
                ...
                new MenuItem() {Header = "qwas3",Uid = "3qwas",ItemsSource  = new ObservableCollection<MenuItem>(new List<MenuItem>()
                {
            ...
            var element = service.GetMenuItem("asdads1");
        ...
        {
            IMenuService service = new MenuService(commandsViewModel.Object);
            commandsViewModel.SetupProperty(x => x.Commands).SetupGet(x => x.Commands).Returns(new ObservableCollection<MenuItem>());
            ...
            Assert.AreEqual(((MenuItem)(commandsViewModel.Object.Commands.SingleOrDefault(x => x.Header.Equals("Asd")).Items[0])).Header, "SubItem");
            ...
            Assert.AreEqual(((MenuItem)((MenuItem)(commandsViewModel.Object.Commands.SingleOrDefault(x => x.Header.Equals("Asd")).Items[0])).Items[0]).Header, "SubSubItem");
            Assert.AreEqual(((MenuItem)((MenuItem)(commandsViewModel.Object.Commands.SingleOrDefault(x => x.Header.Equals("Asd")).Items[0])).Items[0]).Uid, "#MenuItems:Asd|SubItem|SubSubItem");
        }
        ...
        public void CanRemoveOnSpecyficPathMenuItem()
        {
            ...
            Assert.IsNotNull(commandsViewModel.Object.Commands.SingleOrDefault(x => x.Header.Equals("Asd")));
            Assert.AreEqual(commandsViewModel.Object.Commands.SingleOrDefault(x => x.Header.Equals("Asd")).Items.Count, 0);
        ...
        {
            var pre = parent != null ? string.Format("{0}", parent.Uid) : string.Format("#MenuItems:");
