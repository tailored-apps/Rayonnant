...
using TailoredApps.Rayonnant.DependencyInjection.Unity.Extensions;
using TailoredApps.Rayonnant.DependencyInjection.Unity.Extensions.BuildTrackingExtension;
using TailoredApps.Rayonnant.DependencyInjection.Unity.Extensions.CommonLoggingExtension;
...
namespace TailoredApps.Rayonnant.DependencyInjection.Unity
{
    /// <summary>
    ...
    public class UnityContainerAdapter : IContainer
    {
        ...
        public IEnumerable<TailoredApps.Rayonnant.Interface.DependencyInjection.IContainerRegistration> Registrations
        {
